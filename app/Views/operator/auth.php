...
<div class="splash-container">
    <div class="card ">
        <div class="card-header text-center"><a href="<?= base_url('/')?>"><img class="logo-img" src="<?= base_url('assets/admin/images/logo.png')?>" alt="logo"></a><span class="splash-description">Operator Panel Login</span></div>
        <div class="card-body">
            <form method="post" action="<?= base_url('operator/auth/check'); ?>" >
                <?= csrf_field()?>
