...
<div class="splash-container">
    <div class="card ">
        <div class="card-header text-center"><a href="<?= base_url('/')?>"><img class="logo-img" src="<?= base_url('assets/admin/images/logo.png')?>" alt="logo"></a><span class="splash-description">Admin Panel Login</span></div>
        <div class="card-body">
